...
exports.calculateOverlappingSectionsTwoStar = exports.calculateOverlappingSections = exports.convertToCleaningArray = void 0;
...
function calculateOverlappingSectionsTwoStar(cleaningArray) {
    let count = 0;
    cleaningArray.forEach((pair) => {
        const firstPair = pair[0].split(',');
        const secondPair = pair[1].split(',');
...
exports.calculateOverlappingSectionsTwoStar = calculateOverlappingSectionsTwoStar;
